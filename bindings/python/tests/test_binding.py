...
def test_basic_flow() -> None:
    ...
    serialized_event = b'{"type":"data-message","topic":"/topic","@data-type":"vector","data":[{"@data-type":"count","data":1},{"@data-type":"count","data":1},{"@data-type":"vector","data":[{"@data-type":"string","data":"my_event"},{"@data-type":"vector","data":[{"@data-type":"count","data":1},{"@data-type":"string","data":"2"}]},{"@data-type":"vector","data":[]}]}]}'
