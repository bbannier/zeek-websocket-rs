...
While this is primarily a Rust library, we also expose Python bindings with
help from [PyO3](https://github.com/PyO3/pyo3). The intended main component of the
Python bindings is the [`Client`](bindings/python/zeek_websocket/__init__.py)
type which allows to receive and send Zeek events as
